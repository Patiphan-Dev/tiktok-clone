<template>
    ...
    >
        <div class="relative bg-white w-full max-w-[470px] h-fit p-4 rounded-lg">
            ...
            <div class="relative flex items-center justify-center py-3 left-0 bottom-0 border-t w-full">
